...
public class OrderVO {
	...
	private String o_cnum; 	//	char(6 byte)
	...
	public String toString() {
		return "OrderVO [o_seq=" + o_seq + ", o_num=" + o_num + ", o_date=" + o_date + ", o_cnum=" + o_cnum
				...
				+ ", o_total=" + o_total + ", getO_seq()=" + getO_seq() + ", getO_num()=" + getO_num()
				+ ", getO_date()=" + getO_date() + ", getO_cnum()=" + getO_cnum() + ", getO_pcode()=" + getO_pcode()
				+ ", getO_pname()=" + getO_pname() + ", getO_price()=" + getO_price() + ", getO_qty()=" + getO_qty()
				+ ", getO_total()=" + getO_total() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
